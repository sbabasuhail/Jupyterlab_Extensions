...
if (
  ...
  "imports": {
    ...
    "@hv-apps/genai-companion/": "${packageRoot}"
  }
}`;
  ...
  document.body.querySelector(".aiCompanionButton")?.append(reactRootDiv);
  // document.body.querySelector(".aiCompanionButton")?.addEventListener("click", ()=>{
  //   globalThis.dispatchEvent(
  //     new CustomEvent("toggle-companion")
  //   );
  // })
