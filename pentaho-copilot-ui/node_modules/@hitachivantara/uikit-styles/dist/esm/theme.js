import * as index from "./tokens/index.js";
import { mapCSSVars, hasMultipleArgs, spacingUtil, spacingUtilOld } from "./utils.js";
...
const spacing = (...args) => {
  ...
  switch (typeof value) {
    ...
    case "object":
      return value && value.length > 0 ? value.map(spacingUtilOld).join(" ") : "0px";
    default:
      return "0px";
  }
};
