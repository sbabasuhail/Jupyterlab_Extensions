...
const getIconColors = (palette = [], color, semantic, inverted = false) => {
  ...
  if (semantic) {
    colorArray[0] = ((_a = uikitStyles.theme.colors) == null ? void 0 : _a[semantic]) || colorArray[0];
  }
...
const StyledIconBase = /* @__PURE__ */ _styled__default.default("div", process.env.NODE_ENV === "production" ? {
  target: "e13q2m0o0"
} : {
  target: "e13q2m0o0",
...
const IconBase = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(StyledIconBase, { "data-name": iconName, iconSize, style: {
    ...colorVars,
    ...style
  }, ...others, children });
};
...
exports.useIconColor = useIconColor;
exports.useIconSize = useIconSize;
//# sourceMappingURL=IconBase.cjs.map
