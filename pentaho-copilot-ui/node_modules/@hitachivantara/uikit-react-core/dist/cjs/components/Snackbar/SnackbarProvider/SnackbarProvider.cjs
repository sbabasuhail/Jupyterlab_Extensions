...
const HvNotistackSnackMessage = React.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(notistack.SnackbarContent, { ref, children: /* @__PURE__ */ jsxRuntime.jsx(SnackbarContent.HvSnackbarContent, { id, variant, showIcon: true, label: message, role: "none", ...snackbarContentProps }) });
});
const useHvSnackbar = () => {
  const {
  ...
  const enqueueSnackbar = React.useCallback((message, options = {}) => {
    const {
      id,
      variant = "success",
      snackbarContentProps,
...
const HvSnackbarProvider = ({
  ...
  const notistackClasses = {
    containerRoot: /* @__PURE__ */ css.css(process.env.NODE_ENV === "production" ? {
      name: "146ko5x",
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(notistack.SnackbarProvider, { classes: notistackClasses, maxSnack, autoHideDuration, anchorOrigin, className: cx(classes.snackItemRoot, className), ...others, children });
};
...
//# sourceMappingURL=SnackbarProvider.cjs.map
