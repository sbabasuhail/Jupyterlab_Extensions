...
const getHeaderFooterPropsHook = (props, {
  ...
  if (column.className != null || column.headerClassName != null) {
    nextProps.className = clsx.clsx(props.className, column.className, column.headerClassName);
  }
...
const getCellPropsHook = (props, {
  ...
  if (cell.column.className != null || cell.column.cellClassName != null) {
    nextProps.className = clsx.clsx(props.className, cell.column.className, cell.column.cellClassName);
  }
...
//# sourceMappingURL=useTableStyles.cjs.map
