...
const HvDatePicker = (props) => {
  ...
  const {
    classes,
    cx
  } = DatePicker_styles.useClasses(classesProp);
  ...
  const handleApply = () => {
    ...
    setValidationState(() => {
      if (required && (!utils$1.isDate(startDate) || rangeMode && !utils$1.isDate(endDate))) {
        return "invalid";
      }
      return "valid";
    });
  ...
  const handleDateChange = (event, newDate) => {
    ...
    if (autoSave) {
      ...
      setValidationState(() => {
        if (required && !utils$1.isDate(newDate)) {
          return "invalid";
        }
        return "valid";
      });
  ...
  const renderActions = () => /* @__PURE__ */ jsxRuntime.jsxs(ActionBar.HvActionBar, { className: cx({
    [classes.actionContainer]: showClear
  }), children: [
    showClear && /* @__PURE__ */ jsxRuntime.jsx("div", { className: classes.leftContainer, children: /* @__PURE__ */ jsxRuntime.jsx(Button.HvButton, { id: setId.setId(id, "action", "clear"), className: classes.action, variant: "primaryGhost", onClick: handleClear, children: labels == null ? void 0 : labels.clearLabel }) }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: classes.rightContainer, children: [
      /* @__PURE__ */ jsxRuntime.jsx(Button.HvButton, { id: setId.setId(id, "action", "apply"), className: classes.action, variant: "primaryGhost", onClick: handleApply, children: labels == null ? void 0 : labels.applyLabel }),
      /* @__PURE__ */ jsxRuntime.jsx(Button.HvButton, { id: setId.setId(id, "action", "cancel"), className: classes.action, variant: "primaryGhost", onClick: handleCancel, children: labels == null ? void 0 : labels.cancelLabel })
    ] })
  ] });
  const styledTypography = (dateString, variant, text) => {
    const StyledTypography = /* @__PURE__ */ _styled__default.default(Typography.HvTypography, process.env.NODE_ENV === "production" ? {
      target: "e2irjnc0"
    } : {
      target: "e2irjnc0",
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(FormElement.HvFormElement, { id, name, value: dateValue, status: validationState, disabled, required, className: cx(classes.root, className), readOnly, ...others, children: [
    ...
    }, readOnly, disabled, disablePortal, variableWidth: true, placement: horizontalPlacement, expanded: calendarOpen, onToggle: handleToggle, onClickOutside: handleCalendarClose, onContainerCreation: focusOnContainer, placeholder: renderInput(utils.getDateLabel(dateValue, rangeMode, locale)), adornment: /* @__PURE__ */ jsxRuntime.jsx(uikitReactIcons.Calendar, { className: classes.icon, color: disabled ? "secondary_80" : void 0 }), popperProps: {
      modifiers: [{
