...
const HvBaseInput = (props) => {
  ...
  const {
    classes,
    cx
  } = BaseInput_styles.useClasses(classesProp);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cx(classes.root, className, {
      ...
      /* @__PURE__ */ jsxRuntime.jsx(material.Input, { id, name: formElementProps.name, value, defaultValue, type, placeholder, readOnly: !!formElementProps.readOnly, disabled: formElementProps.disabled, onChange: onChangeHandler, className: cx({
