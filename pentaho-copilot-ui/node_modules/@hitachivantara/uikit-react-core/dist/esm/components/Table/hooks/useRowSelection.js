...
const CellWithCheckBox = ({
  ...
  return /* @__PURE__ */ jsx(HvCheckBox, { onChange, checked, disabled, indeterminate, "aria-label": labels.selectRowCheckBoxAriaLabel });
};
...
function useInstance(instance) {
  ...
  ensurePluginOrder(plugins, ["useFilters", "useGroupBy", "useSortBy", "useExpanded", "usePagination"], "useHvRowSelection");
  const rowsToSelect = applyToggleAllRowsSelectedToPrefilteredRows ? initialRowsById : nonGroupedRowsById;
  ...
  useMountedLayoutEffect(() => {
    ...
    if (getAutoResetLockedSelectionRows()) {
      dispatch({
        type: actions.resetLockedSelectionRows
      });
    }
  }, [dispatch, data]);
