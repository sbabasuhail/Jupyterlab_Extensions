...
const NumericValue = ({
  ...
  const renderRangeInputs = (rangeValue) => {
    var _a2, _b2;
    return /* @__PURE__ */ jsxs("div", { className: cx(classes.rangeContainer, {
      [classes.isMdDown]: isMdDown
    }), children: [
      /* @__PURE__ */ jsx("div", { className: classes.inputContainer, children: /* @__PURE__ */ jsx(HvInput, { label: labels.rule.value.numeric.range.leftLabel, className: classes.input, id: `${elementId}-numeric-from`, name: `${elementId}-numeric-from`, value: ((_a2 = rangeValue == null ? void 0 : rangeValue.from) == null ? void 0 : _a2.toString()) || "", onChange: (event, data) => onRangeValueChange(event, data), onBlur: () => {
      ...
      /* @__PURE__ */ jsx("div", { className: classes.inputContainer, children: /* @__PURE__ */ jsx(HvInput, { label: labels.rule.value.numeric.range.rightLabel, className: classes.input, id: `${elementId}-numeric-to`, name: `${elementId}-numeric-to`, value: ((_b2 = rangeValue == null ? void 0 : rangeValue.to) == null ? void 0 : _b2.toString()) || "", onChange: (event, data) => onRangeValueChange(event, data, false), onBlur: () => {
